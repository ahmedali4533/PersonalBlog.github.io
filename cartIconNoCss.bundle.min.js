/*! For license information please see cartIconNoCss.bundle.min.js.LICENSE.txt */ ! function(t, e) {
    ...
    return function() {
        var e = {
                ...
                5731: function(t, e, n) {
                    ...
                    var a = n(1195),
                        s = n.n(a);
                    var c, u, p, l, h, d, f, m, x, y = n(2492),
                        g = n.n(y),
                        v = n(2858),
                        b = n.n(v),
                        E = n(4803),
                        ...
                        L = function(t) {
                            function e(e) {
                                var n;
                                if (n = t.call(this, e) || this, _()(g()(n), "textRef", void 0), e.aspectRatio) {
                                    var r = e.aspectRatio * e.initialViewBoxHeight;
                                    n.state = {
                                        textLength: r - e.initialViewBoxWidth,
                                        width: r
                                    }
                                } else n.state = {
                                    textLength: 0,
                                ...
                                return n.textRef = s().createRef(), n
                            }
                            b()(e, t);
                            var n = e.prototype;
                            return n.componentDidMount = function() {
                                ...
                                var t = this.textRef.current.getComputedTextLength(),
                        ...
                        B = function(t) {
                            function e(e) {
                                ...
                                return (n = t.call(this, e) || this).state = {
                                    isVisible: !!e.aspectRatio
                                }, n.resizeFrame = n.resizeFrame.bind(g()(n)), n
                            }
                            b()(e, t);
                            var n = e.prototype;
                            return n.componentDidMount = function() {
                                ...
                                this.props.text !== t.text && this.setState({
                                    isVisible: !1
                                }, this.resizeFrame)
                            }, n.resizeFrame = function() {
                                var t = this,
                                    e = this.props.containerHeight,
                                    n = this.calculateProportion(),
                                    r = Math.round(100 * e / n);
                                this.props.resizeComponent(r).then((function() {
                                    return t.setState({
                                        isVisible: !0
                                    })
                                })).catch((function() {
                                ...
                                var t, e = this.calculateProportion(),
                                    n = this.props.preserveAspectRatio ? {
                                        preserveAspectRatio: "xMinYMax meet"
                                    } : {},
                                    r = I()(((t = {})[w] = !0, t[T] = !this.state.isVisible, t));
                            ...
                            }, n.calculateProportion = function() {
                                var t = this.props.viewBox.split(" "),
                                    e = t[2],
                                    n = t[3];
                                return parseFloat(n) / parseFloat(e) * 100
                            }, e
                        }(s().PureComponent),
                        O = {
                            cartIconDefaults: "JFG84",
                            cartIconButtonContainer: "_350Q0",
                            quantity: "_2u__n",
                            withoutBackground: "_6mbMh",
                            bubble: "ex_uq",
                            "cart-icon-1": "_1ArCY",
                            cartIcon1: "_1ArCY",
                            dozens: "_158ud",
                        ...
                        S = {
                            ...
                            Icon2: function(t) {
                                return s().createElement(B, A()({
                                    ...
                                    "data-hook": "items-count",
                                    className: I()(t.s.quantity, t.s.withoutBackground),
                                    textAnchor: "middle",
                                    x: "116",
                                    y: "35",
                                    dy: ".48em"
                            ...
                            Icon4: function(t) {
                                return s().createElement(L, {
                                    ...
                                    return s().createElement(B, A()({
                                        viewBox: "0 0 " + n + " " + r,
                                        preserveAspectRatio: !0
                                    }, t), s().createElement("text", {
                                        x: "0",
                                        y: "83",
                                        ref: o,
                                        "data-hook": "free-text"
                                    }, t.text + " ", s().createElement("tspan", {
                                        className: I()(t.s.quantity, t.s.withoutBackground),
                                        "data-hook": "items-count"
                                    }, "(", t.count, ")\u200f")))
                                }))
                        ...
                        P = function(t) {
                            function e(e) {
                                var n;
                                return n = t.call(this, e) || this, _()(g()(n), "anchorRef", void 0), n.anchorRef = s().createRef(), n.onClick = n.onClick.bind(g()(n)), n.reportAppLoaded = n.reportAppLoaded.bind(g()(n)), n.resizeComponent = n.resizeComponent.bind(g()(n)), n
                            }
                            b()(e, t);
                            var n = e.prototype;
                            return n.componentDidMount = function() {
                                ...
                                t.preventDefault(), this.props.isNavigate || t.stopPropagation(), this.safeRun(this.props.onIconClick)
                            }, n.resizeComponent = function(t) {
                                return "Editor" === this.props.host.viewMode ? this.props.host.resizeComponent({
                                    width: t,
                                    height: null,
                                    mobileResize: !0
                                }) : Promise.resolve()
                            }, n.triggerFocus = function() {
                                this.anchorRef.current && this.anchorRef.current.focus(), this.safeRun(this.props.onFocusTriggered)
                            }, n.safeRun = function(t) {
                                this.props.isInteractive && "function" == typeof t && t()
                            }, n.componentKey = function() {
                                var t = this.props.host.style.styleParams.fonts;
                                return "cart-icon-" + N()(JSON.stringify(t))
                            }, n.render = function() {
                                var t;
                                ...
                                var e = this.props,
                                    ...
                                    i = e.displayText,
                                    a = e.isNavigate,
                                    c = this.props.host.style,
                                    u = c && c.styleParams.numbers.cartWidgetIcon || 1,
                                    p = I()(O.cartIconDefaults, O["cart-icon-" + u], O.cartIconButtonContainer, ((t = {})[O.dozens] = o >= 10 && o <= 99, t[O.hundreds] = o >= 100, t));
                    ...
                    var z, F, H, G, V = "https://31e500c94d2042ff81a38a0e4a2873b7@sentry.io/1252955",
                        j = "https://337a342c302c4c0e8c26e425e74da4c1@sentry.io/1363752",
                        W = ((k = {})[c.ADD_TO_CART] = {
                            ...
                            var n = [].concat(e.cssPath || []),
                                r = [].concat(e.rtlCssPath || []),
                                s = [].concat(e.ltrCssPath || []),
                                c = r.length;
                            return function(e) {
                                function u(t) {
                                    var o = e.call(this, t) || this;
                                    o.tokenForCiPoliceRule = "e2425ecc-e4c1-474c-9e2b-8357f32c907b", o.numOfLoaded = 0, o.cssFilesToLoad = function() {
                                    ...
                                    var i = !0;
                                    return "undefined" != typeof window && window.document && window.document.createElement && (o.numOfLoaded = document.querySelectorAll("." + (t.host && t.host.id || t.id) + " link").length, i = o.numOfLoaded === o.cssFilesToLoad.length), o.state = {
                                        linksLoaded: i
                                    }, o.markAsLoaded = o.markAsLoaded.bind(o), o.isInSite = t.host && "Site" === t.host.viewMode, o
                                }
                                return o(u, e), u.prototype.componentDidMount = function() {
                                    for (var t = 0; t < document.styleSheets.length; t++)
                                        if ("string" == typeof document.styleSheets[t].href) {
                                            var e = document.styleSheets[t].href.replace(this.props.cssBaseUrl, "");
                                            this.cssFilesToLoad.indexOf(e) > -1 && this.markAsLoaded()
                                        }
                                }, u.prototype.markAsLoaded = function() {
                                    this.numOfLoaded++, this.numOfLoaded >= this.cssFilesToLoad.length && this.setState({
                                        linksLoaded: !0
                                    })
                                    ...
                                    var e = this,
                                        ...
                                        r = n.cssBaseUrl,
                                        o = n.host,
                                        s = o && o.id || this.props.id,
                                        u = o.shouldSetHeightOnWrapper ? {
                                            height: "100%"
                                        } : {};
                                    return a.createElement("div", {
                                        className: s,
                                        style: u
                                    }, r && c ? this.cssFilesToLoad.map((function(t) {
                                        return a.createElement("link", {
                                            href: "" + r + t,
                                            rel: "stylesheet",
                                            type: "text/css",
                                            key: t,
                                            onLoad: e.markAsLoaded
                                        })
                                    })) : null, c && this.state.linksLoaded ? a.createElement(t, i({}, this.props)) : null, !c && a.createElement(t, i({}, this.props)))
                                }, u
                            }(a.Component)
                        }((G = P, function(t) {
                            return a.createElement(a.StrictMode, null, a.createElement(G, i({}, t)))
                        }), {
                            strictMode: !0
                        }), F = {
                            dsn: V,
                            ...
                            return o(e, t), e.prototype.getLazySentry = function() {
                                ...
                                if (e) {
                                    F.tags && e.configureScope((function(t) {
                                        Object.keys(F.tags).forEach((function(e) {
                                            t.setTag(e, F.tags[e])
                                        }))
                                    }));
                                    var n = this.getRavenUserContextOverrides();
                                    (F.userContext || n) && e.configureScope((function(t) {
                                        t.setUser(i(i({}, F.userContext), n))
                                    })), e.captureException(t)
                                }
                            }, e.prototype.render = function() {
                                return this.state.error && H ? a.createElement(H, i({
                                    error: this.state.error
                                }, this.props)) : a.createElement(z, i({}, this.props))
                            }, e
                        }(a.Component))
                },
                943: function(t) {
                ...
                1586: function(t, e, n) {
                    var r, o, i, a, s;
                    r = n(9677), o = n(943).utf8, i = n(8809), a = n(943).bin, (s = function(t, e) {
                        ...
                        for (var n = r.bytesToWords(t), c = 8 * t.length, u = 1732584193, p = -271733879, l = -1732584194, h = 271733878, d = 0; d < n.length; d++) n[d] = 16711935 & (n[d] << 8 | n[d] >>> 24) | 4278255360 & (n[d] << 24 | n[d] >>> 8);
